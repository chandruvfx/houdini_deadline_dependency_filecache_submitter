...
# import threading
import hdefereval
from hdefereval import threading
...
class DependencyFileCacheSubmitter(QtWidgets.QMainWindow):
        ...
        def __init__(self) -> None:
            ...
            self.show_job_id = []
            self.random_no = random.randint(100, 99999)
        ...
        def generate_deadline_data(self):
            ...
            self.current_hip_folder_path = os.path.dirname(hou.hipFile.path())
            ...
            for sop_nodes in farm_submit_items:
                ...
                sop_node.parm("cache_folder_path").set(self.current_hip_folder_path +"/../cache")
            ...
            if not deadline_job_files:
                ...
                if self.count == 0 and not dep_job_id:
                    ...
                    if deadline_job_files:
                        ...
                        # self.window.close()
                        hdefereval.executeInMainThreadWithResult(self.load)
                        # hou.hipFile.load(self.current_hip_path)
